...
IAM_FOG_MQTT_AUTH_PATH = "devOperate/findJwtToken"
...
MQTT_KEEPALIVE_SECONDS = 65
MQTT_RETRY_SECONDS = 60
MQTT_TOKEN_CHECK_SECONDS = 5
FOG_MQTT_BROKER_HOST = "emqs.ixingoo.com"
FOG_MQTT_BROKER_PORT = 8883
FOG_MQTT_KEEPALIVE_SECONDS = 60
FOG_MQTT_RETRY_SECONDS = 5
FOG_MQTT_RETRY_MAX_SECONDS = 5 * 60
